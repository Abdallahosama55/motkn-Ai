    ...
    <section className="Control">
      <div className="container-fluid p-0 m-0">
        <div className=" p-0  mx-auto">
          <div
            dir="rtl"
            className=" controlHeight overflow-y-scroll   pt-2 pb-4 ">
            <div
              dir="ltr"
              className="containerC">
              <div
                className="welcome  rounded-4    p-4"
                dir="rtl">
                <h3 className=" font-bold fw-bolder font-basic ">
                  مرحبا مصطفى
                </h3>
                <p className="welcome-p  breif-title mt-2 font-basic">
                      ...
                      <div
                        ...
                        <div
                          ...
                          <div className="">
                            ...
                            <p className=" font-light p-welcome-text  ">
                              {item.text}
                            </p>
                          </div>
